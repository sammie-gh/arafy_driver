      ...
      builder: (context, vm, child) {
        return VStack(
          [
            ...
            "${widget.newOrder.pickup.address} (${widget.newOrder.pickup.distance.numCurrency}km)"
                .text
                .semiBold
                .xl
                .make(),
            ...
            "${widget.newOrder.dropoff.address} (${widget.newOrder.dropoff.distance.numCurrency}km)"
                .text
                .semiBold
                .xl
                .make(),
